...
namespace Olive.Website.Tests.Views.Account
{
    ...
    public class IndexTests
    {
        ...
        public void RendersWithoutExceptions()
        {
            ...
            Assert.IsNotNull(
                html.DocumentNode.SelectSingleNode(".//a[@href='/Account/Create']"), 
                "Create current account link missing.");
            Assert.IsNotNull(
                html.DocumentNode.SelectSingleNode(".//a[@href='/Account/Edit/102']"), "Edit account link missing.");
            Assert.IsNotNull(
