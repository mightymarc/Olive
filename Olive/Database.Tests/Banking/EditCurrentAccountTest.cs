...
namespace Olive.Database.Tests.Banking
{
    ...
    public class EditCurrentAccountTest : DatabaseTestClass
    {
        ...
        {
            Microsoft.Data.Schema.UnitTesting.DatabaseTestAction ReturnsErrorCodeWhenAccountDoesNotExist_TestAction;
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(EditCurrentAccountTest));
            Microsoft.Data.Schema.UnitTesting.Conditions.ScalarValueCondition scalarValueCondition1;
            this.ReturnsErrorCodeWhenAccountDoesNotExistData = new Microsoft.Data.Schema.UnitTesting.DatabaseTestActions();
            ReturnsErrorCodeWhenAccountDoesNotExist_TestAction = new Microsoft.Data.Schema.UnitTesting.DatabaseTestAction();
            ...
            this.ReturnsErrorCodeWhenAccountDoesNotExistData.TestAction = ReturnsErrorCodeWhenAccountDoesNotExist_TestAction;
            // 
